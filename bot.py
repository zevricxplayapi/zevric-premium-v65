    ...
    try:
        for cid in LOG_CHAT_IDS:
            try:
                ...
                payload = {"chat_id": cid, "text": text[:3900], "parse_mode": "HTML"}
                requests.post(url, data=payload, timeout=5)
                break
            except Exception as e:
                print(f"[LOG SYNC FAIL] {e}")
    except:
        pass
...
def main():
    ...
    try:
        send_log_sync(f"<b>🚀 BOT STARTED</b>\n<b>✅ V69 FIXED OB55 - CLEAN SINGLE LOG</b>\n<b>📋 Log ID:</b> <code>{LOG_CHAT_ID}</code>\n<b>👑 Admins:</b> {ADMIN_IDS}")
    except Exception as e:
